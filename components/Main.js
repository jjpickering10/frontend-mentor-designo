...
const Main = () => {
  return (
    <div className='bg-peach h-[843px] lg:h-[640px] overflow-hidden mt-24 md:mt-[155px] flex flex-col lg:flex-row items-center relative md:px-[39px] lg:pr-0 md:mx-[39px] lg:mx-[164px] md:rounded-[15px] mb-[60px]'>
