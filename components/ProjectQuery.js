...
const ProjectQuery = () => {
  return (
    <div className='h-[379px] md:h-[350px] lg:h-[292px] mx-6 md:mx-[39px] lg:mx-[165px] bg-peach rounded-[15px] text-center flex flex-col lg:flex-row justify-center lg:justify-between items-center translate-y-1/2 md:translate-y-1/4'>
