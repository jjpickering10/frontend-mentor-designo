const DesignHeader = ({ page }) => {
  return (
    <div className='bg-peach h-[320px] md:h-[252px] overflow-hidden mt-24 md:mt-[155px] flex flex-col lg:flex-row items-center justify-center relative md:px-[39px] md:mx-[39px] lg:mx-[164px] md:rounded-[15px] mb-[60px]'>
